...
import { selectStore } from '../slices/storeSlice';t
   ...
   <View className="flex-1">
    ...
    <View className="rounded-t-3xl -mt-12 bg-white relative">
        <View className="flex-row justify-between px-5 pt-10">
            ...
            <Image className="w-24 h-24" source={require('../assets/image/deliveryrider2.gif')}></Image>
        </View>
        <View
        ...
        className="p-2 flex-row justify-between items-center rounded-full my-5 mx-2">
            ...
            style={{backgroundColor: 'rgba(255,255,255,0.4'}}>
                <Image className="h-16 w-16 rounded-full"source={require('../assets/image/users image/user.png')}/>
            </View>
