   ...
   <View>
    ...
    <ScrollView>
      ...
      className="bg-white -mt-12 pt-6">
        ...
        <View className="px-5">
          ...
          <View className="flex-row items-center space-x-l">
                    <Image source={require('../assets/image/fullStar.png')} className="h-4 w-4" />
      ...
      <View className="pb-36 bg-white">
        <Text className="px-4 py-4 text-2xl font-bold">Camping Items</Text>
        {/* camping items */}
        {
          item.campItems.map((camptool, index)=> <ItemRow item={{...camptool}} key={index}/>)
        }
      </View>
    </ScrollView>
   </View>
